...
class FeedConsumptionPage extends StatelessWidget {
  ...
  FeedConsumptionPage({super.key, required this.feedId});
                    ...
                    onTap: () async {
                      ...
                      if (pickedDate != null) {
                        controller.date.value =
                            DateFormat('d MMMM y', 'tr').format(pickedDate);
                      }
                    },
                    child: IgnorePointer(
                      child: TextFormField(
                ...
                child: FormButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      controller.addFeedConsumption(
                          feedId); // feedId eklenerek tüketim kaydediliyor
