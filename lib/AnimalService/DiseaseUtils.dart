...
class DiseaseUtils {
  ...
  void showSelectionDiseaseSheet(BuildContext context, String title, List<Map<String, dynamic>> options, Function(String) onSelected) {
            ...
            searchController.addListener(() {
              setState(() {
                filteredOptions = options
                    .where((option) => option['diseaseName'].toString().toLowerCase().contains(searchController.text.toLowerCase()))
                    .toList();
              });
            });
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Card(
                                ...
                                child: ListTile(
                                  title: Text(filteredOptions[index]['diseaseName']),
                                  onTap: () {
                                    onSelected(filteredOptions[index]['diseaseName']);
                                    Get.back();
                                  },
                                ),
                              );
