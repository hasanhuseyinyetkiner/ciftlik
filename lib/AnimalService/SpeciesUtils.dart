...
class SpeciesUtils {
  ...
  void showSelectionAnimalSheet(BuildContext context, String title, List<Map<String, dynamic>> options, Function(String) onSelected) {
            ...
            searchController.addListener(() {
              setState(() {
                filteredOptions = options
                    .where((option) => option['animalsubtypename'].toString().toLowerCase().contains(searchController.text.toLowerCase()))
                    .toList();
              });
            });
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Card(
                                ...
                                child: ListTile(
                                  title: Text(filteredOptions[index]['animalsubtypename']),
                                  onTap: () {
                                    onSelected(filteredOptions[index]['animalsubtypename']);
                                    Get.back();
                                  },
                                ),
                              );
