            ...
            searchController.addListener(() {
              setState(() {
                filteredOptions = options
                    .where((option) => option['examinationName'].toString().toLowerCase().contains(searchController.text.toLowerCase()))
                    .toList();
              });
            });
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Card(
                                ...
                                child: ListTile(
                                  title: Text(filteredOptions[index]['examinationName']),
                                  onTap: () {
                                    onSelected(filteredOptions[index]['examinationName']);
                                    Get.back();
                                  },
                                ),
                              );
