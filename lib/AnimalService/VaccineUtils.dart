...
class VaccineUtils {
  ...
  void showSelectionVaccineSheet(BuildContext context, String title, List<Map<String, dynamic>> options, Function(String) onSelected) {
            ...
            searchController.addListener(() {
              setState(() {
                filteredOptions = options
                    .where((option) => option['vaccineName'].toString().toLowerCase().contains(searchController.text.toLowerCase()))
                    .toList();
              });
            });
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Card(
                                ...
                                child: ListTile(
                                  title: Text(filteredOptions[index]['vaccineName']),
                                  onTap: () {
                                    onSelected(filteredOptions[index]['vaccineName']);
                                    Get.back();
                                  },
                                ),
                              );
